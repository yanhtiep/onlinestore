                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                            <div class="smart-search">
                                ...
                                <form class="smart-search-form" method="post">
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-12 hidden-xs">
                            <div class="mini-cart">
                                <a href="{{url('/cart')}}" class="header-mini-cart">
                                    <span class="total-mini-cart-item">{{Cart::count()}} Item(s) - </span>
                                    <span class="total-mini-cart-price">${{Cart::subtotal()}}</span>
                                </a>
                                    ...
                                    <ul class="list-mini-cart-item">
                                        <li>
                                            ...
                                            <div class="mini-cart-thumb">
                                                <a href="#"><img src="{{ASSETS_PATH}}images/home1/mini-cart-thumb.png" alt="" /></a>
                                            </div>
        ...
        <!-- End Header -->
    <script>
    <?php $stock = DB::table('stocks')->get();?>
    $(function(){
        var source = [
            @foreach($stock as $st)
            {
                value: "<?php echo url('/');?>/stock-detail/<?php echo $st->id;?>",
                label: "<?php echo $st->name;?>"
            },
            @endforeach
